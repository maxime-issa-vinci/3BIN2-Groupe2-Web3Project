...
export const cars = [
    ...
    },
    {
        ...
        model: "Aventador",
        power: 730,
        cylinders: 12, // Nombre de cylindres
        displacement: 6.5, // Déplacement en litres
        drive: "AWD", // Type de traction
        max_speed: "350 km/h", // Vitesse maximale
        zero_to_100: "2.9 s", // Accélération de 0 à 100 km/h
